...
const COMMANDS: CommandSpec[] = [
  // ── Navigation ──
  {
    ...
    phrases: {
      ...
      te: ['ఈరోజు', 'డాష్‌బోర్డ్', 'ee roju', 'eeroju'],
      mr: ['आज', 'डॅशबोर्ड', 'काय करायचे', 'kay karayche', 'kay karaycha'],
      bn: ['আজ', 'ড্যাশবোর্ড', 'কি করতে', 'ki korte'],
    },
  },
  {
    ...
    phrases: {
      ...
      te: ['వాతావరణం', 'నీరు', 'నీటి', 'వర్షం', 'vatavaranam', 'vaatavaranam', 'neeru', 'varsham'],
      mr: ['हवामान', 'पाणी', 'सिंचन', 'पाऊस', 'havaman', 'hawaman', 'sinchan', 'paus'],
      bn: ['আবহাওয়া', 'জল', 'সেচ', 'বৃষ্টি', 'abohawa', 'abohaoya', 'brishti', 'sech'],
    },
  },
  {
    ...
    phrases: {
      ...
      te: ['వ్యాధి', 'తెగులు', 'పురుగు', 'ఆరోగ్యం', 'vyadhi', 'tegulu', 'purugu', 'aarogyam'],
      mr: ['रोग', 'कीड', 'आरोग्य', 'किडे', 'kida', 'kide', 'aarogya'],
      bn: ['রোগ', 'পোকা', 'স্বাস্থ্য', 'poka', 'sasthya'],
    },
  },
  {
    ...
    phrases: {
      ...
      te: ['ధర', 'మార్కెట్', 'రేటు', 'dhara', 'retu'],
      mr: ['भाव', 'बाजार', 'दर', 'bajarbhav'],
      bn: ['দাম', 'বাজার', 'দর', 'bajar dam'],
    },
  },
  {
    ...
    phrases: {
      ...
      te: ['నా పొలం', 'నా పంట', 'పంటలు', 'naa polam', 'naa panta', 'pantalu'],
      mr: ['माझे शेत', 'माझे पीक', 'पिके', 'majhe shet', 'majhe pik', 'maza pik'],
      bn: ['আমার খেত', 'আমার ফসল', 'ফসল', 'amar khet', 'amar fosol'],
    },
  },
  {
    ...
    phrases: {
      ...
      pa: ['ਕੀ ਬੀਜਾਂ', 'ਕਿਹੜੀ ਫ਼ਸਲ', 'ਸੁਝਾਅ', 'ki bijan', 'kihri fasal'],
      te: ['ఏమి నాటాలి', 'ఏ పంట', 'సూచన', 'emi nataali', 'e panta', 'soochana'],
      mr: ['काय पेरावे', 'कोणते पीक', 'सूचना', 'kay perave', 'konte pik'],
      bn: ['কী লাগাব', 'কোন ফসল', 'পরামর্শ', 'ki lagabo', 'kon fosol'],
    },
  },
  {
    ...
    phrases: {
      ...
      te: ['ఎరువు', 'యూరియా', 'దిగుబడి', 'eruvu', 'digubadi'],
      mr: ['खत', 'युरिया', 'उत्पादन', 'khat', 'utpadan'],
      bn: ['সার', 'ইউরিয়া', 'ফলন', 'folon'],
    },
  },
  ...
  // ── Actions ──
  {
    ...
    phrases: {
      ...
      te: ['చదివి వినిపించు', 'చెప్పు', 'cheppu', 'cheppandi'],
      mr: ['वाचून दाखवा', 'सांगा', 'sanga', 'vachun dakhva'],
      bn: ['পড়ে শোনাও', 'বলো', 'bolun', 'pore shonao'],
    },
  },
  {
    ...
    phrases: {
      ...
      pa: ['ਸਮੱਸਿਆ ਦਰਜ', 'ਸ਼ਿਕਾਇਤ', 'samassia daraj'],
      te: ['సమస్య నమోదు', 'samasya namodu'],
      mr: ['समस्या नोंदवा', 'samasya nondva'],
      bn: ['সমস্যা জানাও', 'samasya janao'],
    },
  },
  {
    intent: { kind: 'refresh' },
