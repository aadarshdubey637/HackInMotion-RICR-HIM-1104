    ...
    <div className="min-h-dvh lg:flex">
      <aside className="hidden w-64 shrink-0 border-r border-soil-200 bg-white lg:flex lg:flex-col sticky top-0 h-dvh relative overflow-hidden">
        ...
        <div className="absolute bottom-24 left-0 w-full pointer-events-none opacity-[0.05] text-brand-600 z-0">
          <svg viewBox="0 0 200 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
            ...
            <path d="M0,90 Q70,75 140,90 T200,90 L200,100 L0,100 Z" fill="currentColor" opacity="0.7"/>
          ...
          {[...PRIMARY, ...SECONDARY].map(({ href, labelKey, icon: Icon }) => {
            ...
            return (
              ...
              >
                ...
                {active && (
                  <svg className="w-4 h-4 text-emerald-500/40 absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none animate-sprout-grow" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="flex min-w-0 flex-1 flex-col relative overflow-hidden bg-soil-50">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 opacity-[0.14]">
          ...
          <div className="absolute top-[30%] right-[8%] animate-float-medium text-emerald-600" style={{ animationDelay: '-2s' }}>
            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
              <path d="M17,8C8,8 4,12 2,22C8,22 12,18 12,12C12,8 9,4 6,2C8,6 8,10 6,12C4,14 2,16 2,22" />
            </svg>
          </div>
          <div className="absolute bottom-[20%] left-[15%] animate-float-fast text-green-600" style={{ animationDelay: '-4s' }}>
            <svg className="w-10 h-10" viewBox="0 0 24 24" fill="currentColor">
              <path d="M17,8C8,8 4,12 2,22C8,22 12,18 12,12C12,8 9,4 6,2C8,6 8,10 6,12C4,14 2,16 2,22" />
            </svg>
          </div>
          <div className="absolute bottom-[40%] right-[25%] animate-float-slow text-brand-600" style={{ animationDelay: '-6s' }}>
